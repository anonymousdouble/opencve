...
def handle_events(app, open_file):
    ...
    def _handle_events(name, mock_sleep, mock_get):
        mock_get.return_value = ("CVE-2023-1234", arrow.get("2023-12-01T00:00:00.000000+00:00"))
        ...
        with patch("opencve.tasks.events.save_last_cve") as _:
            with patch("opencve.tasks.events.requests") as mock_request:
                ...
                data = {"resultsPerPage":1,"startIndex":0,"totalResults":1,"format":"NVD_CVE","version":"2.0","timestamp":"2023-12-01T00:00:00.00","vulnerabilities":[]}
