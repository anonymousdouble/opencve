...
from tasks.fetchers import fetch_mitre, fetch_nvd, fetch_advisories
from tasks.parsers import parse_nvd, parse_mitre, parse_advisories
...
def changes():
    with TaskGroup(group_id="fetchers") as fetch_group:
        _ = [fetch_mitre(), fetch_nvd(), fetch_advisories()]

    with TaskGroup(group_id="parsers") as parse_group:
        _ = parse_mitre() >> parse_nvd() >> parse_advisories()
